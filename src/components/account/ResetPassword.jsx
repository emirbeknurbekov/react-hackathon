...
import ResetPasswordPageImage from '../../images/ResetPasswordPage.svg'
  ...
  return (
    <div className={style.resetPasswordContainer}>
        ...
        <div className={style.signInSearchBox}>
          <input type="text" placeholder="Search" className={style.signInSearch} />
        </div>
      ...
      <div className={style.resetPasswordMainContentBlock}>
            ...
            <div className={style.resetPasswordImageBlock}>
                <img src={ResetPasswordPageImage} alt="error:)"  className={style.resetPasswordImage}/>
            </div>
        <div className={style.resetPasswordLeftBlock}>
            <div className={style.resetPasswordTitleBlock}>
                ...
                <p className={style.resetPasswordMainTitleP}>Enter your email and we'll send you a link to reset your password.</p>

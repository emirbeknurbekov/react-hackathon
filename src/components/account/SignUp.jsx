...
<div className={style.signInMainContent}>
      ...
      <div className={style.signInPageBox}>
        ...
        <div className={style.signUpEmaildBox}>
          ...
          <input type="text" className={style.signInEmailInput} placeholder = 'designer@gmail.com'/>
        </div>
          ...
          <h5 className={style.signUpPasswordInputP}>Password</h5>
            ...
            <p className={style.signUpP}>Use 8 or more characters with a mix of letters, numbers & symbols</p>
          </div>
          <div className={style.signUpCheckBoxes}>
                <label for="myCheckbox">
              <input type='checkbox'/>
              Agree to our Terms of use and Privacy Policy</label>
                <label for="myCheckbox">
              <input type='checkbox' />  
